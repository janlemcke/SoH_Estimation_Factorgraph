...
module ProjectileEstimationApproximated
...
struct TimeStepGraph
    ...
    F_prev_x_v::ApproximateWeightedSumFactor
...
TimeStepGraph(x::Int64, v::Int64, F_prev_x_v::ApproximateWeightedSumFactor, F_prev_v::ScalingFactor) = TimeStepGraph(x, v, F_prev_x_v, F_prev_v, nothing, 0.0)
TimeStepGraph(x::Int64, v::Int64, F_prev_x_v::ApproximateWeightedSumFactor, F_prev_v::ScalingFactor, F_x_data::GaussianFactor) = TimeStepGraph(x, v, F_prev_x_v, F_prev_v, F_x_data, 0.0)
...
function addTimeStep!(db::DistributionBag, prev_x::Int64, prev_v::Int64; datapoint::Union{Nothing, Pair{Float64, Float64}}=nothing, prev_timestamp::Float64=0.0, time_step::Float64=1.0, beta=2.0, factor_coordinate=(t -> t), bias_coordinate=(t -> 0.0), factor_velocity=(t -> 1.0), bias_velocity=(t -> 0.0))   
    ...
    F_prev_x_v = ApproximateWeightedSumFactor(db, prev_x, prev_v, x, 1.0, factor_coordinate(delta_time), bias_coordinate(delta_time))
